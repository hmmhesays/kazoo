...
-spec get_string_value(key(), object() | objects()) -> api(list()).
...
-spec get_list_value(key(), object() | objects()) -> api(list()).
...
-spec get_ne_value(key(), object() | objects()) -> api(json_term()).
...
%% @end
%%--------------------------------------------------------------------
-spec find(key(), objects()) -> api(json_term()).
...
-spec find_first_defined(key(), objects()) -> api(json_term()).
...
-spec get_value(key(), object() | objects()) -> api(json_term()).
-spec get_value(key(), object() | objects(), Default) -> json_term() | Default.
get_value(Key, JObj) ->
...
-spec get_value1(key(), object() | objects(), Default) -> json_term() | Default.
