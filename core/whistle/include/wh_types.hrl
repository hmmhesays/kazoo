...
-define(CACHE(N), {N, {'kzc_cache', 'start_link', [N]}, 'permanent', 5 * ?MILLISECONDS_IN_SECOND, 'worker', ['kzc_cache']}).
-define(CACHE_ARGS(N, Arg), {N, {'kzc_cache', 'start_link', [N, Arg]}, 'permanent', 5 * ?MILLISECONDS_IN_SECOND, 'worker', ['kzc_cache']}).
