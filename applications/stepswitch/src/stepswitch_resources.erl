...
get('undefined') ->
    case kzc_cache:fetch(?CACHE_NAME, 'global_resources') of
        {'ok', Resources} -> Resources;
        {'error', 'not_found'} -> fetch_global_resources()
    end;
get(AccountId) ->
    case kzc_cache:fetch(?CACHE_NAME, {'local_resources', AccountId}) of
        {'ok', Resources} -> Resources;
...
fetch_global_resources() ->
    ...
    case couch_mgr:get_results(?RESOURCES_DB, ?LIST_RESOURCES_BY_ID, ViewOptions) of
        ...
        {'ok', JObjs} ->
            ...
            kzc_cache:store(?CACHE_NAME, 'global_resources', Resources, CacheProps),
            Resources
    end.
...
fetch_local_resources(AccountId) ->
    ...
    case couch_mgr:get_results(AccountDb, ?LIST_RESOURCES_BY_ID, ViewOptions) of
        ...
        {'ok', JObjs} ->
            ...
            kzc_cache:store(?CACHE_NAME, {'local_resources', AccountId}, LocalResources, CacheProps),
            LocalResources
    end.
