...
-spec route_resp_pre_park_action(wh_json:object()) -> api(xml_el()).
route_resp_pre_park_action(JObj) ->
...
-spec maybe_start_dtmf_action(wh_proplist()) -> api(xml_el()).
maybe_start_dtmf_action(Props) ->
...
-spec check_dtmf_type(wh_proplist()) -> api(xml_el()).
...
-spec condition_el(xml_el() | api(xml_els())) -> xml_el().
